...
function readItemDocs(item) {
    ...
    if ('documentation' in item && item.documentation && typeof item.documentation === 'object') {
        ...
        return (_b = (_a = build.input.sources[source]) === null || _a === void 0 ? void 0 : _a.content) === null || _b === void 0 ? void 0 : _b.slice(start, start + length);
    }
}
...
function decodeSrc(src, build) {
    ...
    const source = Object.keys(build.output.sources).find(s => { var _a; return ((_a = build.output.sources[s]) === null || _a === void 0 ? void 0 : _a.id) === sourceId; });
    if (source === undefined) {
